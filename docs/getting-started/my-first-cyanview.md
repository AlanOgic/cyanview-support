...
<details id="do-i-have-to-change-my-computers-ip-address">
<summary>Do I have to change my computer's IP address?</summary>
...
<details id="the-web-interface-does-not-load-what-should-i-check">
<summary>The web interface does not load. What should I check?</summary>
...
<details id="should-i-update-the-firmware-before-or-after-configuring-my-cameras">
<summary>Should I update the firmware before or after configuring my cameras?</summary>
...
<details id="do-i-need-a-ci0-or-a-rio">
<summary>Do I need a CI0 or a RIO?</summary>
...
<details id="can-i-skip-step-3-and-stay-on-dhcp">
<summary>Can I skip step 3 and stay on DHCP?</summary>
...
<details id="why-does-the-camera-icon-stay-red">
<summary>Why does the camera icon stay red?</summary>
