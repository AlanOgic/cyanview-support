...
:::tip
If you only need iris control and want zoom/focus handled by the camera operator, go to **MENU > LENS > LENS** on the RCP and toggle the Iris / Zoom / Focus switches to enable or disable each control.
