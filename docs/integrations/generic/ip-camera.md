 ...
 **Note:** For now, Cyanview devices only support *CIDR* (/16, /24, ...) entry type. See the [pfSense CIDR reference](https://docs.netgate.com/pfsense/en/latest/network/cidr.html) for an explanation of the notation.
